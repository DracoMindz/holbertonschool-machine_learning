...
class RNNDecoder(tf.keras.layers.Layer):
    ...
    def call(self, x, s_prev, hidden_states):
        ...
        :param x: tensor shape(batch, 1)
                  contains prev word in target sequence
                  as an index of target vocabulary
        ...
        :return: y, s
            y: tensor shape(batch, vocab)
                contains output word sd s one hot vector
        ...
        outputs = tf.reshape(outputs, (-1, outputs.dhape[2]))
